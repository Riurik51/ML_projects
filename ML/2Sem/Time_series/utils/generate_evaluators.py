...
if __name__ == '__main__':
    ...
    valid_evaluator = WRMSSEEvaluator(
            sales_df.iloc[:, :-val_days_qty-test_days_qty],
            sales_df.iloc[:, -val_days_qty - test_days_qty:-test_days_qty],
            dates_df,
            prices_df
            )
    test_evaluator = WRMSSEEvaluator(
            sales_df.iloc[:, :-test_days_qty],
            sales_df.iloc[:, -test_days_qty:],
            dates_df,
            prices_df
            )

    with open('evaluators/valid_evaluator.pkl', 'wb') as f:
            pickle.dump(valid_evaluator, f)

    with open('evaluators/test_evaluator.pkl', 'wb') as f:
